...
public class HizCullingFeature : ScriptableRendererFeature
{
    ...
    public class HizCullingPass : ScriptableRenderPass
    {
        ...
        public static int cullTextureSize = 64;     //最多支持64*64个物体
        public static Texture2D objectCenterTex;    //所有物体AABB的中心点
        public static Texture2D objectSizeTex;      //所有物体AABB的大小
